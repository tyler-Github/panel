<%@ Page Language="C#" MasterPageFile="~/UGCCNG.Master" AutoEventWireup="true" CodeBehind="adminextrasgametype.aspx.cs" Inherits="UGCC_Sharp.adminextrasgt" Title="Extras Tool Management" ValidateRequest="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="alert alert-info" id="alert" runat="server" visible="false">Test</div>
    <div class="form-horizontal">
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <asp:DropDownList ID="ddlGT" runat="server" AutoPostBack="True" CssClass="form-control"
                    OnSelectedIndexChanged="ddlServers_SelectedIndexChanged">
                              
                </asp:DropDownList>
                <span class="help-block">Choose the game type you'd like to manage the extras for.&nbsp;
                    Items with &#39;*&#39; have extras already configured.</span>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label">
            ...
            <div class="col-sm-10">
                ...
                <span class="help-block">List of extras currently setup for the above selected
                    game type.&nbsp; Select one to manage.&nbsp; To add a new item enter a description in the text box at the very bottom and click create.</span>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                ...
                <span class="help-block">Enter the full path and executable with extension the panel should run on Windows.&nbsp; You should use variables for this setting.</span>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label">
            ...
            <div class="col-sm-10">
                ...
                <span class="help-block">Enter the command line arguments to use on Windows.&nbsp; You should use variables for this setting.</span>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label">
            ...
            <div class="col-sm-10">
                ...
                <span class="help-block">Enter the full path and executable with extension the panel should run on Linux.&nbsp; You should use variables for this setting.</span>
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-2 control-label">
            ...
            <div class="col-sm-10">
                ...
                <span class="help-block">Enter the command line arguments to use on Linux.&nbsp; You should use variables for this setting.</span>
            </div>
        </div>
                        <div class="form-group">
            <label class="col-sm-2 control-label">
            ...
            <div class="col-sm-10">
                ...
                <asp:CheckBox ID="chkAdmin" runat="server" />
                    ...
                    <span class="help-block">If checked only admins will be able to see/run this extra.</span>
            </div>
        </div>
                <div class="form-group">
            <label class="col-sm-2 control-label">
            ...
            <div class="col-sm-10">
                <asp:DropDownList ID="DropDownList1" runat="server" CssClass="form-control">
                    <asp:ListItem Value="0" Selected="True">Any State</asp:ListItem>
...
&nbsp;<asp:Button ID="Button2" runat="server" CssClass="btn btn-primary" onclick="Button2_Click" 
            Text="Delete" />
<hr /><p>
    To add a new extra option, select a game type from the top drop down and then enter the option&#39;s desired name/text (it can be changed later) and click
    create.</p>
